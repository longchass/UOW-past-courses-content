...
public abstract class Billing extends User 
{
	...
	{
		this(id,  First,  Last,  username,  Pass,  user,  permis,  value, (Address) null, email);
	...
	{
		this(id,  First,  Last,  username,  Pass,  user,  permis,  value, (Address) null, "default@default.com");
